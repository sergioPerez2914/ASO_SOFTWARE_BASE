...
public class MockInventoryDataSource : IInventoryDataSource
{
    private readonly List<InventoryItem> _items = new()
    {
        ...
        new() { Codigo = "MAN-020", Nombre = "Manguera hidráulica 1/2\"",       Categoria = "Mangueras hidráulicas", Unidad = "m",   Ubicacion = "Almacén C-1", StockActual = 150.5m, StockMinimo = 50,  CostoUnitario = 12.30m },
        ...
        new() { Codigo = "LUB-030", Nombre = "Aceite hidráulico ISO 68",        Categoria = "Lubricantes",           Unidad = "L",   Ubicacion = "Almacén D-3", StockActual = 220.75m, StockMinimo = 100, CostoUnitario = 6.90m },
        new() { Codigo = "LUB-031", Nombre = "Grasa multipropósito",            Categoria = "Lubricantes",           Unidad = "kg",  Ubicacion = "Almacén D-3", StockActual = 45.5m, StockMinimo = 20,  CostoUnitario = 9.50m },
