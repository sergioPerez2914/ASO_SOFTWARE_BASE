...
IF NOT EXISTS (
    ...
    WHERE [MigrationId] = N'20260819024621_Baseline00_EmpleadoInventario'
)
BEGIN
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20260819025032_Fase1_CatalogosSimples'
)
BEGIN
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20260819025329_Fase2_CatalogosConRelaciones'
)
BEGIN
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20260819025551_Fase3_DocumentosPlanos'
)
BEGIN
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20260819025744_Fase4_ColeccionesAnidadas'
)
BEGIN
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20260819025852_Fase5_EventoOperacion'
)
BEGIN
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20260819032146_FixStockActualStockMinimoDecimal'
)
BEGIN
...
BEGIN
    ...
    EXEC(N'INSERT INTO [Organizaciones] ([Id], [Activa], [Codigo], [Nombre])
